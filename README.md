...
| 🛡️ | **[ghostroute](https://github.com/eiler2005/ghostroute)** — router-level VLESS+Reality routing for ASUS Merlin | Shell · iptables · sing-box · xray | Privacy gateway for the whole household, configured once at the router — no apps on phones, no manual VPN toggling. Multi-channel data plane (LAN egress + Reality ingress), survives reboots and ISP changes |
