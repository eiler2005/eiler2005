...
|---|---|---|---|
| 🏛️ | **[praefectus-ai](https://github.com/eiler2005/praefectus-ai)** — your AI sysadmin under contract: an LLM-powered digital steward for Linux VPS administration | Ansible · Python · Bash · LLM contracts · Mermaid · GitHub Actions | The 90% of VPS ops is the same checks every day — disk, memory, certs, containers, secrets. PraefectusAI hires an LLM agent to handle them under an explicit mandate (`AGENTS.md`), narrow scope (`ownership-matrix.md`), and faithful reports back. Battle-tested on a Hetzner CX23; the contract pattern is what makes the agent safe in production |
