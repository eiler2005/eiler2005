...
| 🐾 | **[my-ai-office](https://github.com/eiler2005/my-ai-office)** — always-on personal AI office that turns mail, Telegram and research into a short list of what actually needs me | Python 3.12 · Hermes Agent · Redis Streams · LightRAG · Telethon · Docker · Caddy mTLS | A small staff of digital employees, not a chatbot. Benka the miniature schnauzer takes the questions; six background workers each own a beat — personal mail, work mail, ~200 Telegram channels, market signals, research, knowledge upkeep — and file source-linked briefings on schedule, so my day starts from what changed instead of unread counts. 13 containers on one private VPS. **The entire agent runtime was replaced underneath them (OpenClaw → Hermes) and not one of the staff changed what it does.** |
